              ...
              <div className="ml-2 space-y-1">
                <div className="flex items-center justify-between">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateConfig({ maxIterations: parseInt(e.target.value) })
                    }
                ...
                <div className="flex items-center justify-between">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateConfig({
                        stallThreshold: parseFloat(e.target.value),
                      })
                    }
                ...
                <div className="flex items-center justify-between">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateConfig({
                        divergeThreshold: parseFloat(e.target.value),
                      })
                    }
                    className="input-ghost w-24"
                  />
                ...
                <div className="flex items-center justify-between">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateConfig({
                        restPoseFactor: parseFloat(e.target.value),
                      })
                    }
                    className="input-ghost w-24"
                  />
                ...
                <div className="flex items-center justify-between">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateConfig({
                        translationConvergeThreshold: parseFloat(
                          e.target.value,
                        ),
                      })
                    }
                ...
                <div className="flex items-center justify-between">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateConfig({
                        rotationConvergeThreshold: parseFloat(e.target.value),
                      })
                    }
                    className="input-ghost w-24"
                  />
                ...
                <div className="flex items-center justify-between">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateConfig({
                        translationFactor: parseFloat(e.target.value),
                      })
                    }
                    className="input-ghost w-24"
                  />
                ...
                <div className="flex items-center justify-between">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateConfig({
                        rotationFactor: parseFloat(e.target.value),
                      })
                    }
                    className="input-ghost w-24"
                  />
                ...
                <div className="flex items-center justify-between">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateConfig({
                        translationStep: parseFloat(e.target.value),
                      })
                    }
                    className="input-ghost w-24"
                  />
                ...
                <div className="flex items-center justify-between">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateConfig({ rotationStep: parseFloat(e.target.value) })
                    }
                    className="input-ghost w-24"
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateConfig({
                        translationErrorClamp: parseFloat(e.target.value),
                      })
                    }
                    className="input-ghost w-24"
                  />
                ...
                <div className="flex items-center justify-between">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateConfig({
                        rotationErrorClamp: parseFloat(e.target.value),
                      })
                    }
                    className="input-ghost w-24"
                  />
