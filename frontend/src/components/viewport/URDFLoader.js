...
import { URDFRobot, URDFJoint, URDFLink, URDFCollider, URDFVisual, URDFMimicJoint } from "urdf-loader/src/URDFClasses";
            ...
            children.forEach(n => {
                ...
                if (type === 'geometry') {
                    ...
                    if (geoType === 'mesh') {
                            ...
                            loadMeshCb(filePath, manager, (obj, err) => {
                                if (err) {
                                    ...
                                    if (obj instanceof THREE.Mesh) {
                                        ...
                                        // Prefix mesh name for easier identification
                                        obj.name = (isCollisionNode ? 'collision_' : 'visual_') + (obj.name || '');
                                    }
                        ...
                        // Prefix mesh name for easier identification
                        primitiveModel.name = (isCollisionNode ? 'collision_' : 'visual_') + (primitiveModel.name || '');
                        ...
                        primitiveModel.material = material;a
                        // Prefix mesh name for easier identification
                        primitiveModel.name = (isCollisionNode ? 'collision_' : 'visual_') + (primitiveModel.name || '');
