...
from backend.geometry.pointcloud_transport import (
    PcdAssembly,
    decode_pcd2_chunk,
    iter_encoded_pcd2_chunks,
)
from backend.geometry.surface_reconstruction import compute_surface_points_from_xyz
from backend.models.surface import (
